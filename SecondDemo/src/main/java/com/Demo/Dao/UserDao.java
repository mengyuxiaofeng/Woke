...
public class UserDao {
	...
	{
		String SQL = "update user set user_name=? sex=? head_image=? where user_id=?";
		int re=jdbcTemplate.update(SQL, new Object[] {user.get("user_name"),user.get("sex"),user.get("head_image"), user.get("user_id")});
		return re;
	}
	/*
	 * 修改学生信息
